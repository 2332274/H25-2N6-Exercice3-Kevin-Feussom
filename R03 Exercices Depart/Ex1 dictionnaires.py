...
print(f" le courriel de l'étudiant est : {etudiant}")
...
age_enlevee = etudiant.pop("age")
print(f" on a enlevé l'age de l'étudiant, sa valeur était : {age_enlevee}")
...
nombre_de_paires = len(etudiant)
print(f" Nous avons maintenant {nombre_de_paires} paires clés valeurs.")
